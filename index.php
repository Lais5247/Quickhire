        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('addScheduleBtn').addEventListener('click', function() {
                ...
                newRow.innerHTML = `
                    ...
                    <td><input type="text" class="edit-field" value="New Client"></td>
                    <td>
            ...
            function enterEditMode(row) {
                ...
                cells[3].innerHTML = `<input type="text" class="edit-field" value="${originalData.client}">`;
                cells[4].innerHTML = `
                    <select class="edit-field">
            ...
            function resetRow(row) {
                ...
                cells[3].textContent = original.client;
